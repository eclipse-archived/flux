...
public class CodeStyleConfiguration {
	...
	private static ImportRewrite configureImportRewrite(ImportRewrite rewrite) {
		...
		String thres= "10";//PreferenceConstants.getPreference(PreferenceConstants.ORGIMPORTS_ONDEMANDTHRESHOLD, project);
		try {
		...
		String thresStatic= "10";//PreferenceConstants.getPreference(PreferenceConstants.ORGIMPORTS_STATIC_ONDEMANDTHRESHOLD, project);
		try {
